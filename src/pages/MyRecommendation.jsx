...
const MyRecommendation = () => {
    ...
    const handledelete = async (_id) => {
        const recommendationCount = (recommendationCount)-(1);
                ...
                fetch(`${import.meta.env.VITE_API_URL}/recommendation/${_id}`, {
                    ...
                    .then(data => {
                        ...
                        if (data.deletedCount > 0) {
                            fetch(`${import.meta.env.VITE_API_URL}/updaterecommen/${queries.queryId}`,recoupdate)
                                .then(res => res.json())
                                .then(data => {
                                    console.log(data)
                                })
                            ...
                            const remaining = queries.filter(craft => craft._id !== _id);
