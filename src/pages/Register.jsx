...
const Register = () => {
	...
	return (
		<div className="hero min-h-screen bg-base-200">
			<Helmet>
				<title>shopSwiftly | Register </title>
			</Helmet>
			<div className="hero-content flex-col md:flex-row">
				<div className="text-center lg:text-left">
					<img className="w-full h-full object-cover" src="https://i.ibb.co/cxQQY3Z/sa.jpg" alt="" />
				</div>
				<div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
					<form onSubmit={handleSubmit(onSubmit)} className="card-body">
						<h1 className="text-3xl font-bold text-center capitalize">register now!</h1>
						...
						<div className="form-control mt-6">
							<button className="btn text-white bg-teal-500 hover:bg-teal-600">Register</button>
						</div>
					</form>
